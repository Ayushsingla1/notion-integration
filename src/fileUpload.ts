...
export const uploadImage = async(apiId : string, pageId : string , file : any) => {
...
const requestImageUrl = async(client : Client) => {
    try {
...
const uploadToURL = async(file_upload_id : string, client : Client, imageBlob : any) => {
    try {
...
const appendToPage = async(file_upload_id : string, page_id : string, client : Client) => {
    try {
